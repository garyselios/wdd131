        ...
        rooms: [
            {
                ...
                description: 'A cozy room with a beautiful view of the surrounding forest. Perfect for solo travelers or couples.',
                price: 120,
                size: '30 m²',
                capacity: '2 adults',
                amenities: ['King-size bed', 'Private bathroom', 'Forest view', 'Free Wi-Fi', 'TV', 'Coffee maker'],
                featured: true,
            ...
            },
            {
                ...
                description: 'Spacious suite with a fireplace and private balcony overlooking the mountains.',
                price: 180,
                size: '45 m²',
                capacity: '3 adults',
                amenities: ['King-size bed', 'Sofa bed', 'Fireplace', 'Private balcony', 'Mini bar', 'Jacuzzi'],
                featured: true,
            ...
            },
            {
                id: 3,
                type: 'family',
                name: 'Family Woodland Cabin',
                description: 'Two-bedroom cabin with a living area and kitchenette, perfect for families.',
                price: 250,
                size: '60 m²',
                capacity: '2 adults + 3 children',
                amenities: ['Two bedrooms', 'Living area', 'Kitchenette', 'Fireplace', 'Porch', 'Garden view'],
                featured: true,
            ...
            },
            {
                ...
                description: 'A peaceful room overlooking our manicured gardens. Includes a small seating area.',
                price: 110,
                size: '28 m²',
                capacity: '2 adults',
                amenities: ['Queen-size bed', 'Private bathroom', 'Garden view', 'Free Wi-Fi', 'TV', 'Seating area'],
                featured: false,
            ...
            },
            {
                id: 5,
                type: 'honeymoon',
                name: 'Romantic Treehouse Suite',
                description: 'Secluded treehouse suite with panoramic forest views, perfect for honeymooners.',
                price: 300,
                size: '40 m²',
                capacity: '2 adults',
                amenities: ['King-size canopy bed', 'Private hot tub', 'Romantic fireplace', 'Private deck', 'Champagne on arrival', 'Couples massage package'],
                featured: true,
        ...
        dining: [
            {
                id: 201,
                name: 'Forest Bistro',
                description: 'Casual dining with locally sourced ingredients. Open for breakfast, lunch, and dinner.',
                price: '$$',
                type: 'Casual',
                hours: '7AM - 10PM',
                featured: true,
            ...
            {
                id: 202,
                name: 'Treehouse Dining',
                description: 'Exclusive private dining experience in our elevated treehouse. Reservation required.',
                price: '$$$$',
                type: 'Fine Dining',
                hours: '6PM - 10PM',
                featured: true,
