    ...
    const roomTypes = [
        {
            id: 'standard',
            name: 'Standard Room',
            description: 'Cozy room with forest view, perfect for solo travelers or couples.',
            pricePerNight: 120,
            maxGuests: 2,
            amenities: ['Wi-Fi', 'TV', 'Coffee Maker', 'Private Bathroom'],
            image: 'images/room-standard.jpg'
        },
        {
            id: 'deluxe',
            name: 'Deluxe Suite',
            description: 'Spacious suite with fireplace and balcony overlooking the forest.',
            pricePerNight: 180,
            maxGuests: 3,
            amenities: ['Wi-Fi', 'TV', 'Fireplace', 'Balcony', 'Mini Bar', 'Jacuzzi'],
            image: 'images/room-deluxe.jpg'
        },
        {
            id: 'family',
            name: 'Family Cabin',
            description: 'Two-bedroom cabin perfect for families, with living area and kitchenette.',
            pricePerNight: 250,
            maxGuests: 5,
            amenities: ['Wi-Fi', 'TV', 'Kitchenette', '2 Bedrooms', 'Fireplace', 'Porch'],
            image: 'images/room-family.jpg'
        },
        {
            id: 'honeymoon',
            name: 'Honeymoon Suite',
            description: 'Luxurious suite with king bed, private hot tub, and romantic amenities.',
            pricePerNight: 300,
            maxGuests: 2,
            amenities: ['Wi-Fi', 'TV', 'King Bed', 'Private Hot Tub', 'Champagne', 'Romantic Decor'],
